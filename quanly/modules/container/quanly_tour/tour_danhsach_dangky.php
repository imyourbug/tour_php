...
$tour_dk_select = "SELECT DISTINCT id_tourdulich FROM tbl_dangkytour";
...
<div class="content__body__heading">
    ...
    <div class="content__body__heading-gr">
        <a href="?quanly=tour&query=danhsach" class="content__body__heading-link"><i class="icon-m content__body__heading-link-btn ti-back-left"></i></a>
    </div>
</div>
    ...
    <table class="content__body__table">
        ...
        <tbody>
            ...
            while ($tour_dk_row = mysqli_fetch_array($tour_dk_query)) {
                ...
                if ($tongdk_row['count(id_dangkytour_chitiet)'] <= 0) {
                    continue;
                }
