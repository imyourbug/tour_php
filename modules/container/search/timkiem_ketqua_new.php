        ...
        <div class=\"col l-12 c-12\">
            <div class=\"notification-form\">
                ...
                <div class=\"notification-form-bg\">
                    <img
                        src=\"https://img.freepik.com/free-vector/business-team-looking-new-people-allegory-searching-ideas-staff-woman-with-magnifier-man-with-spyglass-flat-illustration_74855-18236.jpg?t=st=1656654506~exp=1656655106~hmac=493adf1790ef4d0ae14053a5f1464d1ca442d50b678dcbdcb633c4bf2eb3b904&w=1380\"></img>
                </div>
            </div>
        </div>
        ";
    ...
    "<div class=\"col l-4 c-12\">
                <div class=\"content__tour\">
                    <div class=\"content__tour-item\">
                        <a href=\"?select=tour&query=chitiet&idtour=<?php echo $idtour ?>\"
                        class=\"content__tour-item-link\">
                            <img src=\"quanly/modules/container/quanly_tour/uploads/<?php echo $imgtour ?>\"
                            class=\"content__tour-item-img\"></img></a>
                                <?php 
                                if($login)
                                {
                                    $check_tour_like_count = mysqli_num_rows(mysqli_query($mysqli, \"SELECT * FROM tbl_tourdulich_liked WHERE id_nhanvien = '\".$idnv.\"' AND id_tourdulich = '\".$idtour.\"'\"));
                                    if($check_tour_like_count > 0){
                                        ?><div class=\"content__tour-item-like liked\"><a
                    href=\"modules/container/tour/tour_like_xuly.php?select=unlike&idtour=<?php echo $idtour ?>\"><i
                        class=\"fa-solid fa-heart\"></i></a></div><?php
                                    }
                                    else{
                                        ?><div class=\"content__tour-item-like\"><a
                    href=\"modules/container/tour/tour_like_xuly.php?select=like&idtour=<?php echo $idtour ?>\"><i
                        class=\"fa-solid fa-heart\"></i></a></div><?php
                                    }
                                ?>
                                <?php
                                ...
                                <div class=\"content__tour-item-group\">
                                    ...
                                    <p class=\"content__tour-item-group-text\">Giá:
                                        <?php echo number_format($giatour,0,',',',')?> đ</p>
                                    <p class=\"content__tour-item-group-text\">Địa điểm:
                                        <?php echo $diadiemtour ?></p>
                                    <p class=\"content__tour-item-group-text\">Thời gian:
                                        <?php echo date(\"d/m/Y\", strtotime($ngayditour)); ?> -
                                        <?php echo date(\"d/m/Y\", strtotime($ngayvetour)); ?>
                                    </p>
                                    <p class=\"content__tour-item-group-text\">Đăng ký trước:
                                        <?php echo date(\"d/m/Y\", strtotime($dangkytruoctour)); ?>
                                    </p>
                                    <p class=\"content__tour-item-group-text\">Đã đăng ký:
                                        <?php echo $soluongdadangky ?> /
                                        <?php echo $soluongtoida ?>
                                    <div class=\"content__tour-item-group-btn\">
                                        <a href=\"?select=tour&query=chitiet&idtour=<?php echo $idtour ?>\"
                                            class=\"btn-s content__tour-item-group-btn-link\">Xem chi tiết</a>
                                        <a href=\"modules/container/tour/tour_dattour_xuly.php?dat_tour=1&idtour=<?php echo $idtour ?>\"
...
?>
    <div class="col l-4 c-12">
        <div class="content__tour">
            <div class="content__tour-item">
                <a href="?select=tour&query=chitiet&idtour=<?php echo $tour_moi_row['id_tourdulich'] ?>" class="content__tour-item-link"><img src="quanly/modules/container/quanly_tour/uploads/<?php echo $tour_moi_row['img_tourdulich'] ?>" class="content__tour-item-img"></img></a>
                ...
                <div class="content__tour-item-group">
                    ...
                    <div class="content__tour-item-group-btn">
                        <a href="?select=tour&query=chitiet&idtour=<?php echo $tour_moi_row['id_tourdulich'] ?>" class="btn-s content__tour-item-group-btn-link">Xem chi tiết</a>
                        <a href="?select=dangnhap&query=1" class="btn-s btn-main content__tour-item-group-btn-link">Đăng
                            nhập</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col l-12 c-12">
                        <div class="content__label">
                            <h3 class="content__label-heading">Tìm kiếm: <?php echo $keyword ?>. <?php echo $donvi_view ?>.
                                <?php echo $diadiem_view ?> <i class="fa-solid fa-magnifying-glass"></i></h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    ?>
                        ...
                        while ($tour_moi_row = mysqli_fetch_array($tour_query)) {
                            $dangkytruoc = $tour_moi_row['dangkytruoc_tourdulich'];
                            $soluongdadangky = $tour_moi_row['soluongdadangky_tourdulich'];
                            $soluongtoida = $tour_moi_row['soluongtoida_tourdulich'];
                            $idtour = $tour_moi_row['id_tourdulich'];
                            $imgtour = $tour_moi_row['img_tourdulich'];
                            $tentour = $tour_moi_row['ten_tourdulich'];
                            $giatour = $tour_moi_row['gia_tourdulich'];
                            $diadiemtour = $tour_moi_row['diadiem_tourdulich'];
                            $ngayditour = $tour_moi_row['ngaydi_tourdulich'];
                            $ngayvetour = $tour_moi_row['ngayve_tourdulich'];
                            $dangkytruoctour = $tour_moi_row['dangkytruoc_tourdulich'];

                            if (isset($_SESSION['user_login'])) {
                                tour_login($dangkytruoc, $soluongdadangky, $soluongtoida, $idtour, $imgtour, $tentour, $giatour, $diadiemtour, $ngayditour, $ngayvetour, $dangkytruoctour);
                            } else {
                        ?>
                                ...
                                <div class="col l-4 c-12">
                                    <div class="content__tour">
                                        <div class="content__tour-item">
                                            ...
                                            ?>
                                                    <a href="?select=tour&query=chitiet&idtour=<?php echo $tour_moi_row['id_tourdulich'] ?>" class="content__tour-item-link full-ve">
                                                    <?php
                                                } else {
                                                    ?>
                                                        <a href="?select=tour&query=chitiet&idtour=<?php echo $tour_moi_row['id_tourdulich'] ?>" class="content__tour-item-link">
                                                        <?php
                                                    }
                                                } else {
                                                        ?>
                                                        <a href="?select=tour&query=chitiet&idtour=<?php echo $tour_moi_row['id_tourdulich'] ?>" class="content__tour-item-link het-han">
                                                        <?php
                                                    }
                                                        ?>

                                                        <img src="quanly/modules/container/quanly_tour/uploads/<?php echo $tour_moi_row['img_tourdulich'] ?>" class="content__tour-item-img"></img></a>
                                                        ...
                                                        <div class="content__tour-item-group">
                                                            ...
                                                            <div class="content__tour-item-group-btn">
                                                                <a href="?select=tour&query=chitiet&idtour=<?php echo $tour_moi_row['id_tourdulich'] ?>" class="btn-s content__tour-item-group-btn-link">Xem chi tiết</a>
                                                                <a href="modules/container/tour/tour_dattour_xuly.php?dat_tour=1&idtour=<?php echo $tour_moi_row['id_tourdulich'] ?>" class="btn-s btn-main content__tour-item-group-btn-link">Đặt Tour</a>
                                                            </div>
                                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="content__tour">
                                        <div class="content__tour-item">
                                            ...
                                            <div class="content__tour-item-group">
                                                ...
                                                <div class="content__tour-item-group-btn">
                                                    <a href="?select=tour&query=chitiet&idtour=<?php echo $tour_moi_row['id_tourdulich'] ?>" class="btn-s content__tour-item-group-btn-link">Xem chi tiết</a>
                                                    <a href="?select=dangnhap&query=1" class="btn-s btn-main content__tour-item-group-btn-link">Đăng nhập</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
