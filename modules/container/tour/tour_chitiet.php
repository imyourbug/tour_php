    ...
    <div class="container-detail">
        <div class="row">
            <div class="col l-6 c-6" style="display:flex; align-item:center; gap:20px;">
                <a href="?select=tour&query=danhsach" class="btn-s btn-main container-detail-btn-back"><i class="ti-back-left"></i>
                </a>
        ...
        <div class="row">
            <div class="col l-6 c-12">
                <div class="container-detail-heading">
                    <img src="quanly/modules/container/quanly_tour/uploads/<?php echo $tour_chitiet_row['img_tourdulich'] ?>" alt="" id="img-main" class="container-detail-heading-img">
                </div>
            </div>
            <div class="col l-6 c-12">
                <div class="container-detail-heading">
                    ...
                    <div class="container-detail-heading-group">
                        ...
                        <p class="container-detail-heading-group-text">Tour đơn vị:
                            <?php if ($iddv_tour == 0) {
                                ...
                                echo $tour_donvi_row['ten_donvi'];
                            } ?></p>
                    </div>
                    <div class="row">
                        <div class="col l-4 c-4">
                            <img src="https://static.kinhtedothi.vn/images/upload/2022/03/24/halongnmoi.png" class="container-detail-heading-img-mini" id="1" onclick="changeImage('1')">
                        </div>
                        <div class="col l-4 c-4">
                            <img src="http://baobariavungtau.com.vn/dataimages/202112/original/images1690461_vt.jpg" class="container-detail-heading-img-mini" id="2" onclick="changeImage('2')">
                        </div>
                        <div class="col l-4 c-4">
                            <img src="quanly/modules/container/quanly_tour/uploads/<?php echo $tour_chitiet_row['img_tourdulich'] ?>" class="container-detail-heading-img-mini" id="3" onclick="changeImage('3')">
                        </div>
                    </div>
                    <?php
                    ...
                    ?>
                            <a href="modules/container/tour/tour_dattour_xuly.php?dat_tour=1&idtour=<?php echo $tour_chitiet_row['id_tourdulich'] ?>" class="btn-m btn-main disabled-btn">Đặt Tour Ngay</a>

                        <?php
                        } else {
                        ?>
                            <a href="modules/container/tour/tour_dattour_xuly.php?dat_tour=1&idtour=<?php echo $tour_chitiet_row['id_tourdulich'] ?>" class="btn-m btn-main">Đặt Tour Ngay</a>
        ...
        <div class="row">
            ...
            <div class="col l-12 c-12">
                <div class="container-detail-box-img">
                    <img src="quanly/modules/container/quanly_tour/uploads/<?php echo $tour_chitiet_row['img_tourdulich'] ?>" alt="" class="container-detail-img">
                </div>
            </div>
            <div class="col l-12 c-12">
