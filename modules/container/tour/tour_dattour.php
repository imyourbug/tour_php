...
<div class="grid wide">
    <div class="row">
        <div class="col l-12 c-12">
            ...
            ?>
                <div class="container-cart">
                    <div style="display:flex; align-item:center; gap:20px;">
                        <a href="?select=tour&query=danhsach" class="btn-s btn-main container-cart__btn-back"><i class="ti-back-left"></i>
                        </a>
                    ...
                    <div class="container-cart__tour">
                        <img src="quanly/modules/container/quanly_tour/uploads/<?php echo $tour_row['img_tourdulich'] ?>" alt="" class="container-cart__tour-img">
                    ...
                    <div class="container-cart__form">
                        <form action="modules/container/tour/tour_dattour_xuly.php?idtour=<?php echo $idtour ?>" method="POST">
                            <div class="row">
                                <div class="col l-4 c-12">
                                    <div id="form-ve" class="form-tour">
                                        <div class="form-input container-cart__form-group">
                                            ...
                                            <input type="text" value="<?php echo $tour_row['id_tourdulich'] ?>" class="input-df input-df-date container-cart__form-input disabled">
                                        </div>
                                        <div class="form-input container-cart__form-group">
                                            <span class="container-cart__form-label">Mã tài khoản:</span>
                                            <input type="text" value="<?php echo $idnv ?>" class="input-df input-df-date container-cart__form-input disabled">
                                        </div>
                                        <div class="form-input container-cart__form-group">
                                            <span class="container-cart__form-label">Giá vé:</span>
                                            <input type="text" value="<?php echo $tour_row['gia_tourdulich'] ?>" class="input-df input-df-date container-cart__form-input disabled">
                                        </div>
                                        <div class="form-input container-cart__form-group">
                                            <span class="container-cart__form-label">Ngày đặt vé:</span>
                                            <input type="date" name="ngaydat_ve" value="<?php echo $today ?>" class="input-df input-df-date container-cart__form-input disabled">
                                        </div>
                                        <div class="form-input container-cart__form-group">
                                            <span class="container-cart__form-label">Họ tên: <span class="error-txt">*</span></span>
                                            <input type="text" name="ten_ve" id="ten_ve" placeholder="Nhập họ tên..." class="input-df container-cart__form-input" required>
                                        </div>
                                        <div class="form-input container-cart__form-group">
                                            <span class="container-cart__form-label">Số điện thoại: <span class="error-txt">*</span></span>
                                            <input type="tel" name="sdt_ve" id="sdt_ve" maxlength="10" placeholder="Nhập số điện thoại..." onkeypress="return isNumberKey(event);" class="input-df container-cart__form-input" required>
                                        ...
                                        <div class="form-input container-cart__form-group">
                                            ...
                                            <input type="tel" name="cccd_ve" id="cccd_ve" maxlength="12" placeholder="Nhập CCCD/CMND..." onkeypress="return isNumberKey(event);" class="input-df container-cart__form-input" required>
                                        ...
                                        <div class="form-input container-cart__form-group">
                                            ...
                                            <select name="gioitinh_ve" class="input-df input-df-date container-cart__form-input">
                                        ...
                                        <div class="form-input container-cart__form-group container-cart__form-btn">
                                            <input type="submit" name="luu_ve" id="btnsubmit" value="Lưu Vé" class="btn-s container-cart__form-btn-success"></input>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <a href="modules/container/tour/tour_dattour_xuly.php?huytour=1" onclick="return confirm('Bạn chắc chắn muốn hủy tour?');" class="btn-m success-bg-txt container-cart-btn">Hủy
                        Tour</a>
                </div>
            ...
            ?>
                <div class="container-cart">
                    <a href="?select=tour&query=danhsach" class="btn-s btn-main container-cart__btn-back"><i class="ti-back-left"></i></a>
                    <div class="container-cart-status">
                        <div class="arrow-steps clearfix">
                            <div class="step current"><span><a href="">Giỏ Hàng</a></span></div>
                        </div>
